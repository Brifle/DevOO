...
public class TestKernel {
	...
	public void setUpBefore() throws Exception {
		...
		ConnexionCircuit n1 = new ConnexionCircuit();
		LinkedList<Rail> n1sortie = new LinkedList<Rail>();
		n1sortie.add(r1);
		n1.setRailsSortie(n1sortie);

		ConnexionCircuit n2 = new ConnexionCircuit();
		...
		ConnexionCircuit n4 = new ConnexionCircuit();
		LinkedList<Rail> n4sortie = new LinkedList<Rail>();
		n4sortie.add(r4);
		n4.setRailsSortie(n4sortie);

		ConnexionCircuit n5 = new ConnexionCircuit();
