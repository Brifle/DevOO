...
/**
 * Classe utilitaire de géométrie.
 * 
 * @author 
 */
public class Geom {
	...
	/**
	 * Retourne la nouvelle position du point p, après une rotation par rapport 
	 * à un point donné.
	 * @param p Point à faire tourner.
	 * @param centre Centre de la rotation.
	 * @param angle Angle en degrés, de la rotation, en sens horaire.
	 * @return Nouvelle position du point, après rotation.
	 */
